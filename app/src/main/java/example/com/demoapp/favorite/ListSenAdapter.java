 ...
 */
public class ListSenAdapter extends ArraySwipeAdapter<SentenceItem> {
    ...
    public ListSenAdapter(Activity context, int idLayoutResource, ArrayList<SentenceItem> listSentences) {
